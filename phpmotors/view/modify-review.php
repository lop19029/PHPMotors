        ...
        <div class = "page-wrapper">
            ...
            <main>
                ...
                <form method="post" action="/CS%20340/phpmotors/reviews/">
                    ...
                    <textarea id='reviewText' name='reviewText' required><?php if(isset($reviewInfo)){echo $reviewInfo[0]['reviewText'];}?></textarea><br>
                    <br><br>
                    <button type="submit" name="submit" value="Update Review">Update Review</button>
