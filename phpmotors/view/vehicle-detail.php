...
if(!isset($_SESSION['loggedin'])){
    unset ($reviewForm);
    $loginToReview = "<div class='review-form-wrapper'><p>You must <a class='text-link' href='/CS%20340/phpmotors/accounts/?action=Login'>login</a> to write a review.</p></div>";
}
